...
$mikmosLoad = $API->comm("/system/scheduler/print");
...
echo "<tr>";
echo "<td class='text-center'><a title='Remove' href='./?load=scheduler&get=del&id=".$mikmosData['.id']."' class='btn btn-danger btn-xs'><i class='fa fa-trash'></i></a> &nbsp " . $disabled. "</td>";
echo "<td>" . $mikmosData['name']. "</td>";
echo "<td>" . $mikmosData['start-date']. "</td>";
echo "<td>" . $mikmosData['start-time']. "</td>";
echo "<td>" . $mikmosData['interval']. "</td>";
